...
#
# ALSO NEED TO REMOVE ALL IMAGES WHERE PACKAGE_NAME IS > last uploaded CID
...
print("Adding city and country columns...")
cursor.execute("ALTER TABLE open_images ADD COLUMN city")
cursor.execute("ALTER TABLE open_images ADD COLUMN country")
